...
author: "Kiize"
date: 2025-12-16
image: rolling_tail_exponent.png
---
...
Finally, we investigate the approach to market crashes by computing a rolling tail exponent $\alpha$ over a moving time window. Interpreting $\alpha$ as an indicator of instability, we find that it often decreases before major crashes, signaling fattening tails and an increased likelihood of extreme events, much like growing correlations near a critical point in a phase transition. This behavior is evident for the dot-com bubble and the 2008 financial crisis. The COVID-19 crash, however, behaves differently: $\alpha$ drops only during the crash itself, reflecting the fact that it was triggered by an external shock rather than an endogenous market bubble.
...
For a more in-depth discussion, refer to this [pdf](https://kiize.github.io/Market_crashes/tex/main.pdf).