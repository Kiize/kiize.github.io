...
Having said that, we construct the map $f$ using the real non-volume-preserving (NVP) flow approach, that is we costruct $f$ by composition of [affine coupling](affine_couplings.qmd) layers $\{g_{i}\}$
$$
