...
Another useful trick is to integrate by parts to transform the first derivatives into second ones:
$$
...
The key idea is that, having used the integration by parts, the second derivative simplifies our calculations as it preserves the parity symmetry $x \to -x, \tau \to -\tau$, in fact we can write the discretized second derivative as
$$
...
$$
We have omitted the other indices for both cases for simplicity.
